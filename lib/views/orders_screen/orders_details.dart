...
import 'package:mobi_pharma/views/orders_screen/components/order_place_details.dart';
...
class OrdersDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: "Order Details".text.fontFamily(semibold).color(darkred).make(),
      ),
      body: Padding(
          ...
          child: Column(
            children: [
              Column(
                children: [
                  orderStatus(
                    color: Colors.amber.shade800,icon: Icons.done, title: "Placed", showDone: data['order_placed']
                  ),
                  orderStatus(
                          ...
                          SizedBox(
                            ...
                            child: Column(
                              ...
                              children: [
                                 ...
                                 "₹ ${data['total_amount']}".text.color(darkred).fontFamily(bold).make(),
                              ],
                            ),
                          ),
                        ],
